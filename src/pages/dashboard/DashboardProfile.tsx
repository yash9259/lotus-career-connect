...
const DashboardProfile = () => {
  ...
  const [form, setForm] = useState({
    ...
    mobile: mockCandidate.mobile,
    fatherMobile: mockCandidate.fatherMobile,
    gender: mockCandidate.gender,
    dob: mockCandidate.dob,
    maritalStatus: mockCandidate.maritalStatus,
    languages: mockCandidate.languages,
    presentAddress: mockCandidate.presentAddress,
    permanentAddress: mockCandidate.permanentAddress,
  });
